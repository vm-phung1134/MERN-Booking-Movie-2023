...
function ManageUser() {
  ...
  const handleDeleteUser= (id) => {
    ...
    setNewUsers(users.filter((item) => item._id !== id)); //AFTER DELETE SAVE INTO NEW RESERVATION
      ...
      <div className="grid grid-cols-10">
        ...
        <div className="col-span-8">
          ...
          <div className="m-5">
            ...
            <div className="flex justify-start mt-5">
              <div className="rounded-lg shadow-2xl text-center mr-2 p-5">
                ...
                <p className="text-[35px] py-4 font-bold">
                  {newUsers.filter((item) => item.position === "").length}
                </p>
              </div>
              <div className="rounded-lg shadow-2xl text-center mr-2 p-5">
                <h1>SỐ TÀI KHOẢN NHÂN VIÊN</h1>
                <p className="text-[35px] py-4 font-bold">
                  {newUsers.filter((item) => item.position === "Nhân Viên").length}
                </p>
              </div>
            </div>
            <div className="my-5">
            ...
            <h2 className="py-3 mt-3 font-medium">Danh sách khách hàng</h2>
