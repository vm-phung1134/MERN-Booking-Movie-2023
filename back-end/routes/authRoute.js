...
const {login, register, logout, getAllUser, getOneUser, updateUser, changePasswordUser, forgotPassword, updateNewPasswordUser} = require('../controllers/authController')
